...
def request_GPT(client, prompt, max_retries = 10, max_tokens=5, model="gpt-3.5-turbo-instruct", system_prompt=None, temperature=0.7, top_p=0.96):
    num_try = 0
    # print(prompt)
    while num_try < max_retries:
        try:
            ...
            if system_prompt == None:
                system_prompt = f"Assistant is a large language model trained by OpenAI."
