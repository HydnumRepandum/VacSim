...
def profile_gen(incl="neutral"):
    ...
    profile = {}
    if incl == "negative": # augment the likelihood of factors contributing to vaccine hesitancy
        age_dist[0] += 20
        age_dist[1] += 20
        edu_dist[0] += 20
        race_dist[1] += 20
...
if __name__ == "__main__":
    ...
    for i in range(args.num_profiles):
        profiles.append(profile_gen(args.incl))
    output = f"data/profiles-num={args.num_profiles}-incl={args.incl}.pkl" 
